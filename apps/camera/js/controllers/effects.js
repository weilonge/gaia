...
var debug = require('debug')('controller:effects');
var EffectsView = require('views/effects');
...
module.exports = function(app) { return new EffectsController(app); };
module.exports.EffectsController = EffectsController;

/**
 * Initialize a new `EffectsController`
 *
 * @constructor
 * @param {App} app
 */
function EffectsController(app) {
  bindAll(this);
  this.app = app;
  ...
  this.EffectsView = app.EffectsView || EffectsView;
 ...
 */
// EffectsController.prototype.configure = function() {
 ...
 * @private
 */
// EffectsController.prototype.setupRecorderProfilesAlias = function() {
 ...
 * @private
 */
// EffectsController.prototype.setupPictureSizesAlias = function() {
//   var settings = this.settings;
//   this.settings.alias({
//     key: 'pictureSizes',
//     settings: {
 ...
 * @private
 */
// EffectsController.prototype.setupFlashModesAlias = function() {
//   var settings = this.settings;
//   this.settings.alias({
//     key: 'flashModes',
//     settings: {
 ...
 * @private
 */
EffectsController.prototype.bindEvents = function() {
 ...
 * @private
 */
EffectsController.prototype.toggleSettings = function() {
 ...
 * @private
 */
EffectsController.prototype.openSettings = function() {
  debug('open settings');
  if (this.view) { return; }

  var items = this.settings['effects'];

  this.view = new this.EffectsView({ items: items})
    .render()
 ...
 * @private
 */
EffectsController.prototype.closeSettings = function(done) {
 ...
 * @private
 */
EffectsController.prototype.onOptionTap = function(key, setting) {
 ...
 * @private
 */
// EffectsController.prototype.onPickActivity = function(data) {
 ...
 * @private
 */
EffectsController.prototype.notify = function(setting, flashDeactivated) {
 ...
 */
// EffectsController.prototype.onNewCamera = function(capabilities) {
 ...
 * @param  {Array} sizes
 */
// EffectsController.prototype.configurePictureSizes = function(sizes) {
 ...
 * @param  {Array} sizes
 */
// EffectsController.prototype.configureRecorderProfiles = function(sizes) {
 ...
 * @private
 */
EffectsController.prototype.formatPictureSizeTitles = function() {
 ...
 * @return {Array}
 */
EffectsController.prototype.menuItems = function() {
 ...
 * @return {Boolean}
 */
EffectsController.prototype.validMenuItem = function(item) {

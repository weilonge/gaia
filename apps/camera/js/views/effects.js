...
var debug = require('debug')('view:effects');
var OptionsView = require('views/effects-options');
...
module.exports = View.extend({
  ...
  template: function() {
    ...
    '</div>' +
    '<div role="button" class="settings_close js-close" data-icon="effects" ' +
